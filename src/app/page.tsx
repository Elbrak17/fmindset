        ...
        <section className="py-24 relative">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Here&apos;s an example of the personalized insights our AI generates
              </p>
            </div>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl border border-gray-200 shadow-xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-rose-500 to-orange-500 p-6 text-white">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-rose-100 text-sm font-medium">Your Archetype</p>
                      <h3 className="text-2xl md:text-3xl font-bold">Burning Out Founder</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 border-b border-gray-100">
                  <h4 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
                    <span>📈</span> Your Dimension Scores
                  </h4>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      { name: 'Imposter Syndrome', score: 78, color: 'rose' },
                      { name: 'Identity Fusion', score: 85, color: 'orange' },
                      { name: 'Isolation Level', score: 72, color: 'amber' },
                      { name: 'Founder Doubt', score: 65, color: 'yellow' },
                    ].map((dim, i) => (
                      <div key={i} className="text-center p-3 rounded-xl bg-gray-50">
                        <div className={`text-2xl font-bold text-${dim.color}-500`}>{dim.score}%</div>
                        <div className="text-xs text-gray-500 mt-1">{dim.name}</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-indigo-50/50 to-purple-50/50">
                  ...
                  <div className="bg-white rounded-2xl p-5 border border-indigo-100 shadow-sm">
                    <p className="text-gray-700 leading-relaxed italic">
                      &quot;Your profile shows high execution pressure combined with low recovery cycles. You&apos;re deeply 
                      invested in your startup&apos;s success, but this intensity is creating unsustainable patterns. 
                      Your identity fusion score (85%) suggests you may be tying your self-worth too closely to 
                      your company&apos;s performance. The elevated isolation level indicates you might benefit from 
                      connecting with other founders who understand your journey.&quot;
                    </p>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    {[
                      { icon: '🧘', action: 'Schedule 15-min daily decompression time away from work', category: 'Mindfulness' },
                      { icon: '👥', action: 'Join a founder peer group for weekly check-ins', category: 'Social' },
                      { icon: '📝', action: 'Start a daily journal to separate identity from outcomes', category: 'Self-reflection' },
                    ].map((item, i) => (
                      <div key={i} className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-emerald-50 transition-colors">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                  Making founder mental health accessible and actionable
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { 
                    ...
                    desc: 'Identify burnout patterns before they become critical, enabling preventive intervention',
                    metric: 'Catch warning signs early'
                  },
                  { 
                    icon: '🧠', 
                    title: 'Self-Awareness', 
                    desc: 'Help young founders understand their psychological patterns and blind spots',
                    metric: 'Increase emotional intelligence'
                  },
                  { 
                    icon: '💰', 
                    title: 'Low-Cost Access', 
                    desc: 'Provide mental health orientation tools without expensive therapy sessions',
                    metric: 'Free & anonymous'
                  },
                ].map((item, i) => (
                  <div key={i} className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-emerald-100 shadow-lg hover:shadow-xl hover:shadow-emerald-100/50 transition-all duration-300">
              ...
              <div className="mt-10 p-6 rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 text-center">
                <p className="text-gray-700">
                  ...
                  businesses while maintaining their mental health.
                </p>
              </div>
            </div>
          </div>
