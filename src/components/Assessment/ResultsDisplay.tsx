...
export function ResultsDisplay({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
      ...
      {/* AI Generated Insights - Requirements 5.12, 5.13 */}
      <div className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">🤖 AI-Generated Insight</h3>
          ...
          {isLoadingInsights ? (
            <div className="flex items-center justify-center py-8">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-purple-600 text-sm font-medium">Generating personalized insights...</p>
              </div>
            </div>
          ) : groqInsights ? (
            <div className="animate-fade-in">
              <div className="prose prose-sm max-w-none">
                <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">{groqInsights}</p>
              </div>
            ...
            <div className="text-center py-6">
              <p className="text-gray-500 text-sm">We're generating personalized insights for you. Check back in a moment.</p>
            </div>
          )}
        </div>
      </div>
