  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'strong': '0 10px 40px rgba(0, 0, 0, 0.12), 0 4px 12px rgba(0, 0, 0, 0.08)',
        'glow': '0 0 40px rgba(99, 102, 241, 0.25)',
        'glow-lg': '0 0 60px rgba(99, 102, 241, 0.35)',
        'premium': '0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 10px 20px -5px rgba(0, 0, 0, 0.04), 0 20px 40px -10px rgba(99, 102, 241, 0.1)',
      },
      animation: {
